      ...
      <div className="admin screen">
        <div className="overlap-group6-1">
          <div className="overlap-group2-4">
            ...
            <img className="clock-4" src="/img/clock-3@2x.svg" />
          ...
          <img className="backarrow" src="/img/backarrow@2x.svg" />
        </div>
      </div>
    </div>
  );
