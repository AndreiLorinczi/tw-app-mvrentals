...
import { showbookModalDetail } from "../../redux/bookmodal/modal.actions";
...
const RowPoster = result => {
	...
	const handlebookModalOpening = () => {
		dispatch(showbookModalDetail({ ...item, fallbackTitle, genresConverted, isFavourite }));
	}
		...
		>
			...
			<div className="Row__poster-info">
				<div className="Row__poster-info--iconswrp">
					...
					<button className='Row__poster-info--icon icon--favourite' onClick={handlebookModalOpening}>
